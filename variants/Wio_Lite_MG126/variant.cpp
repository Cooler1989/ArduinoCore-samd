...
const PinDescription g_APinDescription[]=
{
  ...
  //44..46 - Seeeduino Wio BLE SPI port
  { PORTA,  8,PIO_SERCOM_ALT,PIN_ATTR_DIGITAL,No_ADC_Channel,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_NMI},  // MOSI,SERCOM2 PAD0
  { PORTA,  9,PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9}, //SCK,SERCOM2 PAD1
  { PORTA, 14,PIO_SERCOM,PIN_ATTR_DIGITAL,No_ADC_Channel,NOT_ON_PWM,NOT_ON_TIMER,EXTERNAL_INT_14},       //MISO ,SERCOM2 PAD2
  //47
  { PORTB, 23, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },
